...
const BookingConfirmation = () => {
  ...
  const { hotel, startDate, endDate, numberOfGuests, totalPrice, formData } =
    location.state as {
      hotel: HotelData;
      startDate: string;
      endDate: string;
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-2/3 md:pl-4">
            ...
            <p className="mb-2 text-teal-600">
              {formData.firstName} {formData.lastName}, a confirmation has been
              sent to your email: <strong>{formData.email}</strong>
            </p>
