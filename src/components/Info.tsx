...
const Info = () => {
	return (
		<div className='bg-[#a6cac4]  bg-cover bg-center py-8 px-4 md:px-0'>
			<div className='max-w-3xl mx-auto text-center'>
				<div className='flex flex-col md:flex-row justify-center items-center  gap-4'>
					<div className=''>
						...
						>
							...
							<g id='SVGRepo_iconCarrier'>
								<circle fill='#008593' cx='236.966' cy='236.966' r='236.966' />
								<g>
									<path
										fill='#FFC50B'
					...
					<div className='w-50 md:w-1/2 text-white'>
						<h2 className='text-2xl font-semibold mb-2'>The 10 best luxury hotels</h2>
						<p>Our special accommodations are regularly in the top 10 hotels...</p>
					</div>
				</div>
			</div>
		</div>
