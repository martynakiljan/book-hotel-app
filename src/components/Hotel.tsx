...
const Hotel: React.FC<{ hotel: HotelProps }> = ({ hotel }) => {
	return (
		<div className='py-8 border-b-2 border-teal-600 md:flex hotel-container'>
			<div className='md:w-1/3'>
				<img
					src={hotel.src}
					alt={hotel.name}
					className='hotel-img w-full h-auto md:object-cover md:aspect-w-16 md:aspect-h-4 max-h-220 mx-4'
				/>
			</div>
			<div className='md:w-2/3 md:p-4 mx-4'>
